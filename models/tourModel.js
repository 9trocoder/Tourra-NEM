...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      maxlength: [
        40,
        'This tour name must have less or equal than 40 characters'
      ],
      minlength: [
        10,
        'This tour name must have more or equal than 10 characters'
      ]
      // validate: [
      //   validator.isAlpha,
    ...
    maxGroupSize: {
      type: Number,
      required: [true, 'This tour must have a group size']
    },
    difficulty: {
      type: String,
    ...
    priceDiscount: {
      type: Number,
      validate: {
        // not going to work on updating document, it only works when creating a new document.
    ...
    imageCover: {
      type: String,
      required: [true, 'This tour must have a cover image']
    },
    images: [String],
    createdAt: {
      type: Date,
